 ...
 * @author Heshan
 */
public class customersmainframe_update_operator extends javax.swing.JFrame {
     ...
     */
    public customersmainframe_update_operator() {
        initComponents();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       try {
        ...
        Logger.getLogger(customersmainframe_update_operator.class.getName()).log(Level.SEVERE, null, ex);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(customersmainframe_update_operator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new customersmainframe_update_operator().setVisible(true);
            }
        });
    }
